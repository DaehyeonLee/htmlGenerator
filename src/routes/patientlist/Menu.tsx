      ...
      <div className="module-menu-hover2_new">
        <div className="frame-1131_new">
          <div className="group-742_new">
            ...
            {/* <div className="etc-logo_new">
              <div className="group-686_new">
                <svg
                  className="group13_new"
                  width="50"
                  height="36"
                  viewBox="0 0 50 36"
                  fill="none"
