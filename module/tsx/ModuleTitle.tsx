...
import "../m_css/ModuleTitle.css";

export interface IModuleTitleProps {}

export const ModuleTitle = ({ ...props }: IModuleTitleProps): JSX.Element => {
  return (
    <div className="module-title">
      <div className="frame-1119">
        <div className="">결과보기</div>
      </div>
      ...
      <div className="component-13-search-box-3">
        ...
        <div className="input-box-search">
          <div className="frame-909">
            <div className="v2">검색어를 입력해 주세요.</div>
